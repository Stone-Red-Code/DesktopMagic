...
internal class W32
{
    ...
    /// <summary>
    /// Window Styles.
    /// The following styles can be specified wherever a window style is required. After the control has been created, these styles cannot be Pluginified, except as noted.
    /// </summary>
    [Flags]
    public enum WindowStyles : uint
    {
        ...
        /// You can turn this style on and off to change dialog box navigation. To change this style after a window has been created, use the SetWindowLong function.
        /// For user-created windows and Plugineless dialogs to work with tab stops, alter the message loop to call the IsDialogMessage function.
        /// </summary>
        WS_TABSTOP = 0x10000,
    ...
    public enum WindowStylesEx : uint
    {
        ...
        /// </summary>
        WS_EX_DLGPluginALFRAME = 0x00000001,
